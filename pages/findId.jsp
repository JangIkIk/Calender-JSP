...
<html>
    ...
    <body>
        <main class="h-full flex justify-center items-center text-center">
            <div class="w-500">
                <h1 class="p-10 border-bt-1sb">아이디 찾기</h1>
                <form class="p-10 flex column gap-10" method="post" action="/stageus/actions/findIdAction.jsp">
                    <div><input name="userName" class="w-full p-10 radius-5" type="text" placeholder="가입시 이름을 입력해주세요"></div>
