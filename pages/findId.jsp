    ...
    <body>
        <main class="layout">
            <div class="layout-container">
                ...
                <form class="layout-container-form" method="post" action="/stageus/actions/findIdAction.jsp">
                    <div><input class="form-input" name="userName" type="text" placeholder="가입시 이름을 입력해주세요"></div>
